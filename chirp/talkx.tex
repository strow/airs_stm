...
\begin{center}
\includegraphics[width=1.0\linewidth]{./Figsx/Pdf/airs2cris_stm_talk1_landscape.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{./Figsx/Pdf/airs2cris_stm_talk1_small.pdf}
\end{center}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.95\linewidth]{./Figsx/Pdf/ap_decon_corr.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.95\linewidth]{./Figsx/Pdf/a2cris_nedt.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\begin{center}
\includegraphics[width=\linewidth]{./Figsx/Pdf/hyperall_hamming.pdf}
\end{center}
\end{block}
\end{column}
...
\begin{center}
\includegraphics[width=\linewidth]{./Figsx/Pdf/a2c_full.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/a2c_full_show_sim.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/a2c_full_show_dead.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/a2c_full_show_noise.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/a2c_full_show_dead_noise_water.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\begin{frame}[label={sec:org90792f6}]{Validation: PDF's of Single Channels}
\begin{itemize}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/jun4_2015_airs_675wn_global_counts_w_airsnoise.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/jun4_2015_airs_675wn_global_counts_w_airsnoise_and_cris.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/jun4_2015_airs_675wn_global_counts_w_airsnoise_and_cris_a2c.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=0.77\linewidth]{./Figsx/Pdf/jun4_2015_airs_675wn_global_counts_w_airsnoise_and_cris_a2c_no_airs.pdf}
\end{center}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=\linewidth]{./Figsx/Pdf/snpp_vs_airs_sno.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=\linewidth]{./Figsx/Pdf/snpp_vs_airs_stats.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\begin{center}
\includegraphics[width=0.65\linewidth]{./Figsx/Pdf/sno_march2018_snpp_minus_noaa20_with_c2_airs_ingrey.pdf}
\end{center}
...
\begin{frame}[label={sec:org7d0b395}]{Time Series Tests}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge4c9a93}]{Pros of CHIRP}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf9da9c}]{Cons of CHIRP}
\begin{itemize}
...
\begin{frame}[label={sec:org03154f8}]{Future Work: AIRS L1c is a pre-requisite for AIRS2CrIS}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcfadd40}]{Future Work: CHIRP Algorithm}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8dbb6a1}]{Future Work: CHIRP RTA}
\begin{itemize}
