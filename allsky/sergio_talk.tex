...
\begin{frame}{UMBC Retrieved Clear Sky OBS Geophysical Anomalies $\rightarrow$ Geophysical Rates : T(z,lat)}
%% see /home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeProfs/plot_anomalies.m
\vspace{-0.35in}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=\linewidth]{Figs/ClearAnom/era_clr_ptemp_rate_200209_201808.png}
\end{center}
\end{block}
\end{column}
